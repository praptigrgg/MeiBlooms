...
<div class="container my-5">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6">
            <img src="{{ asset('images/about.jpg') }}" class="img-fluid rounded-4 shadow" alt="About Mei Blooms">
        </div>
        <div class="col-md-6">
            <div class="p-4">
                <h3 class="mb-3 text-secondary">Our Story 🌷</h3>
                <p class="fs-5">
                    At <strong>Mei Blooms</strong>, we believe every flower has a story to tell. From cheerful birthdays to heartfelt apologies, we design bouquets that speak emotions. Based in Pokhara, we blend nature’s beauty with Nepalese warmth.
                </p>
                <p class="fs-5">
                    With a passion for floristry and customer happiness, we bring vibrant moments to life — one petal at a time.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-5">
        @php
            $testimonials = [
                ['text' => 'Best flowers in Pokhara! Delivered on time and beautifully arranged.', 'name' => 'Aayusha'],
